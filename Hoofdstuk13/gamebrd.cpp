...
void GameBoard::hit()
{
    ...
    if(hits->intValue() == 10 || hits->intValue() == 20 || hits->intValue() == 30 || hits->intValue() == 40)
    	shotsLeft->display(shotsLeft->intValue() + 10);
    if(hits->intValue() == 50)
	shotsLeft->display(shotsLeft->intValue() + 20);
	hits->display( hits->intValue() + 5 );
